...
const AdminAvailabilityPage = lazy(() => import("./admin/AdminAvailabilityPage"));
const AdminContentManager = lazy(() => import("./admin/AdminContentManager"));
const AdminDashboardPage = lazy(() => import("./admin/AdminDashboardPage"));
const AdminForgotPasswordPage = lazy(() => import("./admin/AdminForgotPasswordPage"));
const AdminLayout = lazy(() => import("./admin/AdminLayout"));
const AdminLeadManager = lazy(() => import("./admin/AdminLeadManager"));
const AdminLocationsPage = lazy(() => import("./admin/AdminLocationsPage"));
