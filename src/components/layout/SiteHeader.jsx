  ...
  return (
    <header ref={headerRef} className="fixed inset-x-0 top-0 z-50 bg-[#070707]/95 text-white shadow-[0_12px_45px_rgba(0,0,0,.28)] backdrop-blur-xl">
      ...
      <div className={`${shell} flex min-h-[76px] items-center justify-between gap-5`}>
        <NavLink to="/" onClick={() => setOpen(false)} aria-label="Royalties Buffet home" className="group flex shrink-0 items-center focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#d8ab4d]"><img src="/royalties-logo.png" alt="Royalties Buffet" className="h-14 w-auto object-contain transition group-hover:scale-[1.03] sm:h-16" /></NavLink>
